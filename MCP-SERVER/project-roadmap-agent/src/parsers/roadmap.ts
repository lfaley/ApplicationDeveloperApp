...
import { RoadmapFeature, FeatureStatus, Sprint } from '../types';
...
export class RoadmapParser {
   ...
   */
  private extractFeatures(content: string): RoadmapFeature[] {
   ...
   */
  private parseFeatureBlock(title: string, body: string): RoadmapFeature | null {
   ...
   */
  private extractId(title: string, body: string): string | undefined {
   ...
   */
  private extractStatus(body: string): FeatureStatus {
   ...
   */
  private extractSprint(body: string): string | undefined {
   ...
   * Extract assignee
   */
  private extractAssignee(body: string): string | undefined {
   ...
   */
  private extractDate(body: string, type: 'start' | 'target' | 'completed'): string | undefined {
    const patterns = {
      start: /\*\*Start Date[:\s]+([^\*\n]+)/i,
   ...
   */
  private extractDependencies(body: string): string[] | undefined {
   ...
   */
  private extractBlockers(body: string): string[] | undefined {
   ...
   * Parse sprint block
   */
  private parseSprintBlock(name: string, body: string): Sprint | null {
