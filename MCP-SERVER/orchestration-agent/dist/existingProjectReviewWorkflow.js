 ...
 */
export const existingProjectReviewWorkflow = {
    pattern: 'sequential',
    agents: [
    ...
    description: 'Existing project review, guided user goals, and standards-based documentation generation.',
};
//# sourceMappingURL=existingProjectReviewWorkflow.js.map