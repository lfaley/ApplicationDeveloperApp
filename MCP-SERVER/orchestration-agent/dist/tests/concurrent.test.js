...
describe('ConcurrentPattern', () => {
    ...
    describe('Validation', () => {
        ...
        test('should warn about dependencies in concurrent mode', () => {
            ...
            const result = pattern.validate(request);
            expect(result.warnings).toContain('Agent agent2 has dependsOn specified, but concurrent execution ignores dependencies');
        });
...
//# sourceMappingURL=concurrent.test.js.map