...
import { generateDocstringForFunction, type DocstringStyle } from '../generators/docstring.js';
import { generateXmlDocForFunction } from '../generators/xmldoc.js';
import { generateHelpForFunction } from '../generators/help.js';
 ...
 * Tool handler
 */
export async function generateDocumentationTool(args: unknown) {
  try {
